...
public interface ICustomerRepository
{
    ...
    Task<bool> EmailExistsAsync(Guid excludedId, Email email, CancellationToken token = default);
    Task<bool> CpfExistsAsync(Cpf cpf, CancellationToken token = default);
    Task<bool> CpfExistsAsync(Guid excludedId, Cpf cpf, CancellationToken token = default);
